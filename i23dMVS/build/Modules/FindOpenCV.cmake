...
if(EXISTS "${OpenCV_DIR}")
	...
	foreach(__CVLIB ${OpenCV_LIB_COMPONENTS_ALL})
        ...
        find_library(OpenCV_${__CVLIB}_LIBRARY_ALL NAMES "${__CVLIB}" "opencv_${__CVLIB}" PATHS "/usr/lib/x86_64-linux-gnu" NO_DEFAULT_PATH)
        find_library(OpenCV_${__CVLIB}_LIBRARY_ALL NAMES "${__CVLIB}" "opencv_${__CVLIB}" PATHS "/usr/local/lib" PATH_SUFFIXES "opencv")
