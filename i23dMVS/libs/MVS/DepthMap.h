...
typedef TImage<float> ScaleMap;
typedef TImage<float> ConfidenceMap;
typedef I23D::cList<Depth,Depth,0> DepthArr;
typedef I23D::cList<DepthMap,const DepthMap&,2> DepthMapArr;
typedef I23D::cList<NormalMap,const NormalMap&,2> NormalMapArr;
typedef I23D::cList<ConfidenceMap,const ConfidenceMap&,2> ConfidenceMapArr;
/*----------------------------------------------------------------*/
...
struct DepthData {
	...
	typedef I23D::cList<ViewData,const ViewData&,2> ViewDataArr;
...
typedef I23D::cList<DepthData,const DepthData&,1> DepthDataArr;
/*----------------------------------------------------------------*/
